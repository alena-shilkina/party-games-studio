...
const PHOTO_CONTRACT=`EDITORIAL PARTY PHOTOGRAPHY — this is a photograph for a magazine feature, NOT a printable sheet, NOT flat vector art, NOT an illustration.
- Shoot it as a real styled scene: the subject in its setting — a dressed table, backdrop, linens, glassware, florals, candles, confetti and other tasteful props that tell the story of the celebration.
...
- Rich, warm, inviting mood — the kind of picture that makes a mum want to recreate it. Never a bare object floating on an empty white background, never a clip-art or infographic look.
...
- PHYSICAL PLAUSIBILITY: structures must be buildable and complete — an arch is a single continuous, well-proportioned, free-standing shape resting on the floor with both legs visible, never fused into a wall, never broken, warped, floating or trailing off. Cakes sit level on a stand, tiers are aligned and structurally sound.
